...
public class LunchAndDinnerAdapter extends RecyclerView.Adapter<LunchAndDinnerAdapter.ViewHolder> {

    private List<MyList> list;
    private Context mCtx;

    public LunchAndDinnerAdapter(List<MyList> list, Context mCtx) {
        this.list = list;
        this.mCtx = mCtx;
    }
    ...
    @Override
    public void onBindViewHolder(LunchAndDinnerAdapter.ViewHolder holder, int position) {
